      ...
      <ScrollView>
        ...
        {/* ///FOCUS///// */}
            <View style={styles.Focus}>
              ...
              <View>
                <Text h3 style={styles.Title}>Tech and Engineering</Text>
                <Avatar size="large" rounded icon={{ name: 'plug', type:'font-awesome'}} containerStyle={{alignSelf:'center'}}/>
              ...
              <View>
                <Text h3 style={styles.Title}>Art</Text>
                <Avatar size="large" rounded icon={{ name: 'cube', type: 'font-awesome'}} containerStyle={{alignSelf:'center'}} />
              ...
              <View>
                <Text h3 style={styles.Title}>Science</Text>
                <Avatar size="large" rounded icon={{ name: 'sun-o', type:'font-awesome' }} containerStyle={{alignSelf:'center'}} />
          ...
          <View>
           <Text h1 style={styles.Header}>Provisons</Text>
            <View>
              <Text h3 style={styles.Title}>Room Rentals</Text>
              <Avatar size="large" rounded icon={{ name: 'tv', type: 'Entypo' }} containerStyle={{alignSelf:'center'}}/>
            ...
            <View>
            <Text h3 style={styles.Title}>Hack Friendly</Text>
              <Avatar size="large" rounded icon={{ name: 'wrench', type:'foundation' }} containerStyle={{alignSelf:'center'}} />
            ...
            <View>
            <Text h3 style={styles.Title}>Knowledge Base</Text>
              <Avatar size="large" rounded icon={{ name: 'gears', type:'font-awesome' }} containerStyle={{alignSelf:'center'}} />
